...
async function loadVideo() {
    ...
    container.innerHTML = `
        <div class="main-video-section">
          <div class="video_player">
            <video class="main-video" nocontrols>
  <source src="${video.videoUrl}" type="video/webm">
    Your browser does not support the video tag.
</video>
          </div>
          <div class="video-header">
            <img class="channel-logo" src="../../assets/videos/pics/logo/logo-vd.webp" alt="logo">
    ...
    const video_player = container.querySelector('.video_player');
  ...
  <div class="captions">
    ...
    function updateButtons() {
      likeBtn.classList.toggle("active-btn", userReaction === "like");
